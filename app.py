...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'igwemary'  
...
@app.route('/Eastern_ng')
def Eastern_ng():
    # Your code to render kampala_initiatives.html goes here
    return render_template('Eastern_ng.html')

@app.route('/Western_af')
def Western_af():
    return render_template('Western_af.html')
@app.route('/Northen_ng')
def Northern_ng():
    return render_template('Northern_ng.html')

@app.route('/Southern_ng')
def Southern_ng():
    return render_template('Southern_ng.html')
